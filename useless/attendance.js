...
{
    //get al the grades taken by the loged in faculty
...
$(function(e)
{
    ...
    $(document).on("click",".cbpresent",function(e){
      ...
      //studentid=??, ispresent,gradeid,facultyid,sessionid
      //date
      ...
      let ondate=$("#dtpondate").val();
      //alert(studentid+" "+gradeid+" "+facultyid+" "+sessionid+" "+ondate);
    ...
    $(document).on("click","#btnReport",function(){
        alert("CLICKED");
        //send the session grade faculty to server
